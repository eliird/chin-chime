...
def process_video_with_augmentations(path: str, emotion: str, save_folder: str,num_imgs=10):
    ...
    while True:
        ...
        save_path = os.path.join(save_folder, 'landmarks', filename + f'_{saved_count}_1.npy') 
        saved = save_landmarks(frame, save_path=save_path)
        save_path = os.path.join(save_folder, 'landmarks', filename + f'_{saved_count}_2.npy') 
        saved = save_landmarks(flipped_frame, save_path=save_path)
        if saved:
            save_path = os.path.join(save_folder, 'images', filename + f'_{saved_count}_1.jpg') 
            save_image(frame, save_path)
            save_path = os.path.join(save_folder, 'images', filename + f'_{saved_count}_2.jpg') 
            save_image(flipped_frame, save_path)
